...
import com.azify.ModuleOfficialIDPhotoFragment;
...
public class NetworkingRequest{
    public static void send(
        ...
        try {
            ...
            // Please see extensive notes in ModuleActivity for more details.
            ...
            if (!ModuleActivity.demonstrationExternalDatabaseRefID.isEmpty()) {
                sessionRequestCallPayload.put("externalDatabaseRefID", ModuleActivity.demonstrationExternalDatabaseRefID);
            }
        }
        ...
        try {
            ...
            if (result.has("officialIDPhotoImage")) {
                ...
                if (!photo.isEmpty()) {
                    ...
                    ModuleOfficialIDPhotoFragment.latestOfficialIDPhoto = BitmapFactory.decodeByteArray(decodedBytes, 0, decodedBytes.length);
                }
            }
        }
        catch (JSONException e) {
