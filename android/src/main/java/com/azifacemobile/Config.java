...
public class Config {
  ...
  public static FaceTecCustomization retrieveConfigurationCustomization(Theme theme) {
    ...
    OcrConfirmation ocrConfirmation = theme.getOcrConfirmation();
    Button ocrConfirmationButton = ocrConfirmation.getButton();
    ScrollIndicator ocrConfirmationScrollIndicator = ocrConfirmation.getScrollIndicator();
    InputField ocrConfirmationInputField = ocrConfirmation.getInputField();
    ...
    ocrConfirmationCustomization.scrollIndicatorBorderColor = ocrConfirmationScrollIndicator.getBorderColor();
    ocrConfirmationCustomization.scrollIndicatorBorderWidth = ocrConfirmationScrollIndicator.getBorderWidth();
    ocrConfirmationCustomization.scrollIndicatorCornerRadius = ocrConfirmationScrollIndicator.getCornerRadius();
    ocrConfirmationCustomization.scrollIndicatorElevation = ocrConfirmationScrollIndicator.getElevation();
    ...
    ocrConfirmationCustomization.inputFieldBorderWidth = ocrConfirmationInputField.getBorderWidth();
    ...
    ocrConfirmationCustomization.inputFieldPlaceholderFont = ocrConfirmationInputField.getFont();
