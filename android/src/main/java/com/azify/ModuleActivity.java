...
import com.azify.databinding.ActivityMainBinding;
...
public class ModuleActivity extends Activity {
    ...
    ModuleOfficialIDPhotoFragment moduleOfficialIDPhotoFragment;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Utilities.configureInitialSampleAppUI(this);
        Utilities.displayStatus(this, "Initializing...");
    ...
    private void onFaceTecSDKInitializationSuccess(FaceTecSDKInstance sdkInstance) {
        ...
        Utilities.enableAllButtons(this);

        // Set your FaceTec Device SDK Customizations.
        ThemeHelpers.setAppTheme(this, Utilities.currentTheme);
        ...
        Utilities.setOCRLocalization(this);

        // Set the FaceTec Customization defined in the Config File.
        Utilities.setVocalGuidanceSoundFiles();
        Utilities.setUpVocalGuidancePlayers(this);
        Utilities.displayStatus(this, "Initialized Successfully.");
    }
    ...
    private void onFaceTecSDKInitializationFailure(FaceTecInitializationError error) {
        Utilities.displayStatus(this, error.toString());
    }

    // Initiate a 3D Liveness Check.
    public void onLivenessCheckPressed(View v) {
        Utilities.fadeOutMainUIAndPrepareForFaceTecSDK(this, () -> {
    ...
    public void onVerifyUserPressed(View v) {
        if (demonstrationExternalDatabaseRefID.isEmpty()) {
            Utilities.displayStatus(this, "Please enroll first before trying verification.");
            return;
        }
...
//        moduleOfficialIDPhotoFragment = new ModuleOfficialIDPhotoFragment();
//        FragmentTransaction transaction = getFragmentManager().beginTransaction();
//        transaction.replace(R.id.officialIDFragmentLayout, moduleOfficialIDPhotoFragment);
...
//        });
    ...
    public void onVocalGuidanceSettingsButtonPressed(View v) {
        Utilities.setVocalGuidanceMode(this);
    }
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (successful && moduleOfficialIDPhotoFragment != null) {
            ModuleOfficialIDPhotoFragment.handleSampleAppOfficialIDPhotoResult(this);
            return;
        }


        ModuleOfficialIDPhotoFragment.exitSampleAppOfficialIDFragment(this);
        Utilities.displayStatus(this, "See logs for more details.", false);
        Utilities.fadeInMainUI(this);
    }
    ...
    public void onThemeSelectionPressed(View view) {
        Utilities.showThemeSelectionMenu(this);
    }

    @Override
    public void onBackPressed() {
        if (moduleOfficialIDPhotoFragment != null) {
            ModuleOfficialIDPhotoFragment.exitSampleAppOfficialIDFragment(this);
        }
        else {
            super.onBackPressed();
