...
public class AzifaceMobileSdkModule extends ReactContextBaseJavaModule {
  ...
  private void handleAziFaceConfiguration(@NonNull Map params, ReadableMap headers) {
    try {
  ...
  public void initializeSdk(ReadableMap params, ReadableMap headers, com.facebook.react.bridge.Callback callback) {
    ...
    handleAziFaceConfiguration(params.toHashMap(), headers);
  ...
  public void handleFaceUser(ReadableMap config, Promise promise) {
    ...
    if (!isInitialized) {
      this.processorPromise.reject(this.initializationMessage, "AziFaceHasNotBeenInitialized");
      return;
    }
    ...
    getSessionToken(new SessionTokenCallback() {
      ...
      public void onSessionTokenReceived(String sessionToken) {
        ...
        latestProcessor = new FaceProcessor(sessionToken, reactContext.getCurrentActivity(),
            AzifaceMobileSdkModule.this, faceConfig);
      }
    });
  }
