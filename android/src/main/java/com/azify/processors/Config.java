...
public class Config {
  ...
  public static FaceTecCustomization retrieveConfigurationWizardCustomization() {
    ...
    defaultCustomization.getGuidanceCustomization().buttonBackgroundNormalColor = guidance
        .getButton().getBackgroundNormalColor();
    defaultCustomization.getGuidanceCustomization().buttonBackgroundDisabledColor = guidance
        .getButton().getBackgroundDisabledColor();
    defaultCustomization.getGuidanceCustomization().buttonBackgroundHighlightColor = guidance
        .getButton().getBackgroundHighlightColor();
    defaultCustomization.getGuidanceCustomization().buttonTextNormalColor = guidance.getButton()
        .getTextNormalColor();
    defaultCustomization.getGuidanceCustomization().buttonTextDisabledColor = guidance.getButton()
        .getTextDisabledColor();
    defaultCustomization.getGuidanceCustomization().buttonTextHighlightColor = guidance.getButton()
