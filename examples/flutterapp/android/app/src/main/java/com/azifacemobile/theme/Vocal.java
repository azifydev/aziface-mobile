...
public class Vocal {
    ...
    public static void setUpVocalGuidancePlayers(Context module) {
        vocalGuidanceOnPlayer = MediaPlayer.create(module, R.raw.vocal_guidance_on);
        vocalGuidanceOffPlayer = MediaPlayer.create(module, R.raw.vocal_guidance_off);
        vocalGuidanceMode = Vocal.VocalGuidanceMode.MINIMAL;
    }

    public static void setVocalGuidanceMode(Context module) {
    ...
    public static boolean isDeviceMuted(Context module) {
        AudioManager audio = (AudioManager) module.getSystemService(Context.AUDIO_SERVICE);
